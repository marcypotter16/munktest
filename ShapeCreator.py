...
class ShapeCreator(State):
    def __init__(self, game):
        ...
        self.draw_joints_label = Label(self.canvas, 350, 0, fg_color=pg.Color("white"), text="Draw springs, click with right button to stop drawing joints")
        ...
        self.UI.extend([self.draw_points_label, self.draw_points_cb, self.draw_joints_label, self.start_simulation_label, self.start_simulation])
